...
export const ActiveNav = ({title,path='',length,status}:TabProps) => {
  ...
  return (
    <Link href={path} passHref className={cn("flex pl-4 h-16 items-center justify-center gap-4", {
    ...
    <div className={cn("flex py-1 px-3 flex-col justify-center items-center bg-tab rounded-[10px]",{
