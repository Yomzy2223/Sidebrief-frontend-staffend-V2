    ...
    <div className="flex gap-6">
      ...
      <div className="flex flex-1 gap-6 p-6 border rounded">
        ...
        {/* <RealBox
          ...
          number={`${numeral(convertToOneSignificantFigure(props.numberOfBusinesssVerified)).format(
            "0,0"
          )}+`}
          percentThisMonth={25}
        />
        <RealBox
          title="AMOUNT SPENT"
          number={`#${numeral(convertToOneSignificantFigure(props.totalAmountSpent)).format(
            "0,0"
          )}+`}
          percentThisMonth={25}
        /> */}
